...
unalloc116,
unalloc117,
(VoidFunc)n_graphics_draw_circle,
(VoidFunc)n_graphics_draw_line,
unalloc120,
unalloc121,
unalloc122,
...
(VoidFunc)app_event_loop,        // app_event_loop, VERIFIED
UNIMPL,                                                                             
UNIMPL,                                                                             
(VoidFunc)app_log_trace,          // app_log, VERIFIED
...
(VoidFunc)bitmap_layer_create,   // bitmap_layer_create,
(VoidFunc)bitmap_layer_destroy,  // bitmap_layer_destroy,
(VoidFunc)bitmap_layer_get_layer, // bitmap_layer_get_layer,
UNIMPL, // bitmap_layer_set_alignment,
UNIMPL, // bitmap_layer_set_background_color_2bit,
(VoidFunc)bitmap_layer_set_bitmap, // bitmap_layer_set_bitmap,
(VoidFunc)bitmap_layer_set_compositing_mode, // bitmap_layer_set_compositing_mode,
...
(VoidFunc)cos_lookup,                   // cos_lookup,
...
(VoidFunc)fonts_get_system_font,        // fonts_get_system_font,
UNIMPL,       // fonts_load_custom_font,
UNIMPL,     // fonts_unload_custom_font,
(VoidFunc)free,                         // free,
(VoidFunc)gbitmap_create_as_sub_bitmap, // gbitmap_create_as_sub_bitmap,
(VoidFunc)gbitmap_create_with_data,     // gbitmap_create_with_data,
(VoidFunc)gbitmap_create_with_resource, // gbitmap_create_with_resource,
(VoidFunc)gbitmap_destroy,              // gbitmap_destroy,
UNIMPL,                       // gmtime,
(VoidFunc)n_gpath_create,                 // gpath_create,
(VoidFunc)n_gpath_destroy,                // gpath_destroy,
    UNIMPL,     // gpath_draw_filled_legacy,
UNIMPL,           // gpath_draw_outline,
(VoidFunc)n_gpath_move_to,                // gpath_move_to,
(VoidFunc)n_gpath_rotate_to,              // gpath_rotate_to,
UNIMPL,                 // gpoint_equal,
...
(VoidFunc)n_graphics_draw_circle,                        // graphics_draw_circle,
(VoidFunc)n_graphics_draw_line,                        // graphics_draw_line,
(VoidFunc)n_graphics_draw_pixel,                        // graphics_draw_pixel,
(VoidFunc)n_graphics_draw_rect,                        // graphics_draw_rect,
UNIMPL,                        // graphics_draw_round_rect,
(VoidFunc)n_graphics_fill_circle,                        // graphics_fill_circle,
(VoidFunc)n_graphics_fill_rect,                        // graphics_fill_rect,
UNIMPL,                        // graphics_text_layout_get_max_used_size,
UNIMPL,                        // grect_align,
(VoidFunc)grect_center_point,                        // grect_center_point,
UNIMPL,                        // grect_clip,
UNIMPL,                        // grect_contains_point,
UNIMPL,                        // grect_crop,
UNIMPL,                        // grect_equal,
UNIMPL,                        // grect_is_empty,
(VoidFunc)p_n_grect_standardize,                        // grect_standardize,
UNIMPL,                        // gsize_equal,
UNIMPL,                        // inverter_layer_create,
UNIMPL,                        // inverter_layer_destroy,
UNIMPL,                        // inverter_layer_get_layer,
(VoidFunc)layer_add_child,                        // layer_add_child,
(VoidFunc)layer_create,                        // layer_create,
(VoidFunc)layer_create_with_data,                        // layer_create_with_data,
(VoidFunc)layer_destroy,                        // layer_destroy,
(VoidFunc)layer_get_bounds,                        // layer_get_bounds,
UNIMPL,                        // layer_get_clips,
UNIMPL,                        // layer_get_data,
(VoidFunc)layer_get_frame,                        // layer_get_frame,
(VoidFunc)layer_get_hidden,                        // layer_get_hidden,
(VoidFunc)layer_get_window,                        // layer_get_window,
UNIMPL,                        // layer_insert_above_sibling,
UNIMPL,                        // layer_insert_below_sibling,
(VoidFunc)layer_mark_dirty,                        // layer_mark_dirty,
(VoidFunc)layer_remove_child_layers,                        // layer_remove_child_layers,
(VoidFunc)layer_remove_from_parent,                        // layer_remove_from_parent,
(VoidFunc)layer_set_bounds,                        // layer_set_bounds,
UNIMPL,                        // layer_set_clips,
(VoidFunc)layer_set_frame,                        // layer_set_frame,
(VoidFunc)layer_set_hidden,                        // layer_set_hidden,
(VoidFunc)layer_set_update_proc,                        // layer_set_update_proc,
UNIMPL,                        // light_enable,
UNIMPL,                        // light_enable_interaction,
UNIMPL,                              // localtime__deprecated,
(VoidFunc)malloc,                       // malloc,
(VoidFunc)memcpy,                       // memcpy,
(VoidFunc)memmove,                      // memmove,
(VoidFunc)memset,                       // memset,
...
UNIMPL,                        // psleep,
UNIMPL,                        // rand,
(VoidFunc)resource_get_handle,          // resource_get_handle,
(VoidFunc)resource_load,                        // resource_load,
UNIMPL,                        // resource_load_byte_range,
(VoidFunc)resource_size,                        // resource_size,
...
(VoidFunc)sin_lookup,                        // sin_lookup,
(VoidFunc)snprintf,                        // snprintf,
(VoidFunc)srand,                        // srand,
(VoidFunc)strcat,                        // strcat,
(VoidFunc)strcmp,                        // strcmp,
(VoidFunc)strcpy,                        // strcpy,
UNIMPL,                        // strftime,
(VoidFunc)strlen,                        // strlen,
UNIMPL,                        // strncat,
(VoidFunc)strncmp,                        // strncmp,
UNIMPL,                        // strncpy,
...
(VoidFunc)tick_timer_service_subscribe,                        // tick_timer_service_subscribe,
(VoidFunc)tick_timer_service_unsubscribe,                        // tick_timer_service_unsubscribe,
...
(VoidFunc)window_create,                // window_create,
(VoidFunc)window_destroy,               // window_destroy,
(VoidFunc)window_get_click_config_provider, // window_get_click_config_provider,
UNIMPL,            // window_get_fullscreen,
(VoidFunc)window_get_root_layer,        // window_get_root_layer,
UNIMPL,                        // window_is_loaded,
UNIMPL,                        // window_set_background_color_2bit,
(VoidFunc)window_set_click_config_provider,                        // window_set_click_config_provider,
UNIMPL,                        // window_set_click_config_provider_with_context,
UNIMPL,                        // window_set_fullscreen,
UNIMPL,                        // window_set_status_bar_icon,
(VoidFunc)window_set_window_handlers,                        // window_set_window_handlers,
UNIMPL,                        // window_stack_contains_window,
UNIMPL,                        // window_stack_get_top_window,
UNIMPL,                        // window_stack_pop,
UNIMPL,                        // window_stack_pop_all,
(VoidFunc)window_stack_push,                        // window_stack_push,
UNIMPL,                        // window_stack_remove,
UNIMPL,                        // app_focus_service_subscribe,
UNIMPL,                        // app_focus_service_unsubscribe,
(VoidFunc)window_get_user_data,                        // window_get_user_data,
(VoidFunc)window_set_user_data,                        // window_set_user_data,
...
(VoidFunc)window_long_click_subscribe,                        // window_long_click_subscribe,
(VoidFunc)window_multi_click_subscribe,                        // window_multi_click_subscribe,
(VoidFunc)window_raw_click_subscribe,                        // window_raw_click_subscribe,
(VoidFunc)window_set_click_context,                        // window_set_click_context,
(VoidFunc)window_single_click_subscribe,                        // window_single_click_subscribe,
(VoidFunc)window_single_repeating_click_subscribe,                        // window_single_repeating_click_subscribe,
(VoidFunc)graphics_draw_text,                        // graphics_draw_text,
...
(VoidFunc)calloc,                       // calloc,
(VoidFunc)bitmap_layer_get_bitmap,      // bitmap_layer_get_bitmap,
(VoidFunc)UNIMPL,                        // menu_layer_legacy2_set_callbacks,
...
(VoidFunc)bitmap_layer_set_background_color,                        // bitmap_layer_set_background_color,
(VoidFunc)graphics_context_set_fill_color,                        // graphics_context_set_fill_color,
(VoidFunc)graphics_context_set_stroke_color,                        // graphics_context_set_stroke_color,
(VoidFunc)graphics_context_set_text_color,                        // graphics_context_set_text_color,
UNIMPL,                        // rot_bitmap_layer_set_corner_clip_color,
(VoidFunc)window_set_background_color,                        // window_set_background_color,
...
(VoidFunc)gbitmap_create_blank,                        // gbitmap_create_blank,
(VoidFunc)n_graphics_capture_frame_buffer,                        // graphics_capture_frame_buffer,
(VoidFunc)n_graphics_capture_frame_buffer_format,                        // graphics_capture_frame_buffer_format,
...
(VoidFunc)gbitmap_create_blank_with_palette,                        // gbitmap_create_blank_with_palette,
(VoidFunc)gbitmap_get_bounds,                        // gbitmap_get_bounds,
(VoidFunc)gbitmap_get_bytes_per_row,                        // gbitmap_get_bytes_per_row,
(VoidFunc)gbitmap_get_data,                        // gbitmap_get_data,
(VoidFunc)gbitmap_get_format,                        // gbitmap_get_format,
(VoidFunc)gbitmap_get_palette,                        // gbitmap_get_palette,
(VoidFunc)gbitmap_set_bounds,                        // gbitmap_set_bounds,
(VoidFunc)gbitmap_set_data,                        // gbitmap_set_data,
(VoidFunc)gbitmap_set_palette,                        // gbitmap_set_palette,
...
(VoidFunc)gbitmap_create_from_png_data,                        // gbitmap_create_from_png_data,
...
(VoidFunc)graphics_context_set_antialiased,                        // graphics_context_set_antialiased,
(VoidFunc)graphics_context_set_stroke_width,                        // graphics_context_set_stroke_width,
...
(VoidFunc)gbitmap_create_palettized_from_1bit,                        // gbitmap_create_palettized_from_1bit,
UNIMPL,                        // menu_cell_layer_is_highlighted,
UNIMPL,                        // graphics_draw_rotated_bitmap,
UNIMPL,                        // action_bar_layer_set_icon_press_animation,
(VoidFunc)text_layer_create,                        // text_layer_create,
(VoidFunc)text_layer_destroy,                        // text_layer_destroy,
(VoidFunc)text_layer_get_content_size,                        // text_layer_get_content_size,
(VoidFunc)text_layer_get_layer,                        // text_layer_get_layer,
(VoidFunc)text_layer_get_text,                        // text_layer_get_text,
...
(VoidFunc)text_layer_set_text,                        // text_layer_set_text,
(VoidFunc)text_layer_set_text_alignment,                        // text_layer_set_text_alignment,
(VoidFunc)text_layer_set_text_color,                        // text_layer_set_text_color,
(VoidFunc)n_gdraw_command_draw,                        // gdraw_command_draw,
(VoidFunc)n_gdraw_command_frame_draw,                        // gdraw_command_frame_draw,
(VoidFunc)n_gdraw_command_frame_get_duration,                        // gdraw_command_frame_get_duration,
(VoidFunc)n_gdraw_command_frame_set_duration,                        // gdraw_command_frame_set_duration,
(VoidFunc)n_gdraw_command_get_fill_color,                        // gdraw_command_get_fill_color,
(VoidFunc)n_gdraw_command_get_hidden,                        // gdraw_command_get_hidden,
(VoidFunc)n_gdraw_command_get_num_points,                        // gdraw_command_get_num_points,
(VoidFunc)n_gdraw_command_get_path_open,                        // gdraw_command_get_path_open,
(VoidFunc)n_gdraw_command_get_point,                        // gdraw_command_get_point,
(VoidFunc)n_gdraw_command_get_radius,                        // gdraw_command_get_radius,
(VoidFunc)n_gdraw_command_get_stroke_color,                        // gdraw_command_get_stroke_color,
(VoidFunc)n_gdraw_command_get_stroke_width,                        // gdraw_command_get_stroke_width,
(VoidFunc)n_gdraw_command_get_type,                        // gdraw_command_get_type,
(VoidFunc)n_gdraw_command_image_clone,                        // gdraw_command_image_clone,
(VoidFunc)n_gdraw_command_image_create_with_resource,                        // gdraw_command_image_create_with_resource,
(VoidFunc)n_gdraw_command_image_destroy,                        // gdraw_command_image_destroy,
(VoidFunc)n_gdraw_command_image_draw,                        // gdraw_command_image_draw,
(VoidFunc)n_gdraw_command_image_get_bounds_size,                        // gdraw_command_image_get_bounds_size,
(VoidFunc)n_gdraw_command_image_get_command_list,                        // gdraw_command_image_get_command_list,
(VoidFunc)n_gdraw_command_image_set_bounds_size,                        // gdraw_command_image_set_bounds_size,
(VoidFunc)n_gdraw_command_list_draw,                        // gdraw_command_list_draw,
(VoidFunc)n_gdraw_command_list_get_command,                        // gdraw_command_list_get_command,
(VoidFunc)n_gdraw_command_list_get_num_commands,                        // gdraw_command_list_get_num_commands,
(VoidFunc)n_gdraw_command_list_iterate,                        // gdraw_command_list_iterate,
(VoidFunc)n_gdraw_command_sequence_clone,                        // gdraw_command_sequence_clone,
(VoidFunc)n_gdraw_command_sequence_create_with_resource,                        // gdraw_command_sequence_create_with_resource,
(VoidFunc)n_gdraw_command_sequence_destroy,                        // gdraw_command_sequence_destroy,
(VoidFunc)n_gdraw_command_sequence_get_bounds_size,                        // gdraw_command_sequence_get_bounds_size,
(VoidFunc)n_gdraw_command_sequence_get_frame_by_elapsed,                        // gdraw_command_sequence_get_frame_by_elapsed,
(VoidFunc)n_gdraw_command_sequence_get_frame_by_index,                        // gdraw_command_sequence_get_frame_by_index,
(VoidFunc)n_gdraw_command_sequence_get_num_frames,                        // gdraw_command_sequence_get_num_frames,
(VoidFunc)n_gdraw_command_sequence_get_play_count,                        // gdraw_command_sequence_get_play_count,
(VoidFunc)n_gdraw_command_sequence_get_total_duration,                        // gdraw_command_sequence_get_total_duration,
(VoidFunc)n_gdraw_command_sequence_set_bounds_size,                        // gdraw_command_sequence_set_bounds_size,
(VoidFunc)n_gdraw_command_sequence_set_play_count,                        // gdraw_command_sequence_set_play_count,
(VoidFunc)n_gdraw_command_set_fill_color,                        // gdraw_command_set_fill_color,
(VoidFunc)n_gdraw_command_set_hidden,                        // gdraw_command_set_hidden,
(VoidFunc)n_gdraw_command_set_path_open,                        // gdraw_command_set_path_open,
(VoidFunc)n_gdraw_command_set_point,                        // gdraw_command_set_point,
(VoidFunc)n_gdraw_command_set_radius,                        // gdraw_command_set_radius,
(VoidFunc)n_gdraw_command_set_stroke_color,                        // gdraw_command_set_stroke_color,
(VoidFunc)n_gdraw_command_set_stroke_width,                        // gdraw_command_set_stroke_width,
...
(VoidFunc)n_gdraw_command_frame_get_command_list,                        // gdraw_command_frame_get_command_list,
UNIMPL,                        // gcolor_equal,
...
(VoidFunc)layer_get_unobstructed_bounds,                        // layer_get_unobstructed_bounds,
