...
from pebblepng import convert_png_to_pebble_png_bytes
import struct
import json
import os
import sys
...
class ResourceFile(Resource):
    def __init__(self, coll, j, generated = False):
        super().__init__(coll, j)
    ...
    def __init__(self, fname, root = "."):
        ...
        for res in jdb["resources"]:
            if res["input"]["type"] == "file":
                self.resources.append(ResourceFile(self, res, generated = "generated" in res["input"]))
