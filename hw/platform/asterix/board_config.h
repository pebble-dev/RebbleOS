...
#define BOARD_DISPLAY_PIN_MOSI 3
#define BOARD_DISPLAY_PIN_SCK  2
#define BOARD_DISPLAY_PIN_SCS  25
...
#define BOARD_QSPI_JEDEC_ID QSPI_JEDEC_ID_MX25L64 // TBD

#define BOARD_DEBUG_UART_TXD 29 // TBD
