...
SRCS_stm32f2xx += FreeRTOS/portable/GCC/ARM_CM4F/port.c

LDFLAGS_stm32f2xx = $(LDFLAGS_rebbleos)
LDFLAGS_stm32f2xx += -Wl,-Thw/chip/stm32f2xx/stm32f2xx.lds

LIBS_stm32f2xx = $(LIBS_rebbleos)
