/* nrf52_ls013b7dh03.c
 * Display driver for LS013B7DH03 attached via SPI to nRF52840
 * RebbleOS
 *
...
static uint8_t _display_fb[168][18];
...
void hw_display_init() {
    ...
    DRV_LOG("hw", APP_LOG_LEVEL_INFO, "nrf52_ls013b7dh03: hw_display_init");
}
...
static uint8_t _dispbuf[DISPLAY_LINES_PER_CHUNK * 18 + 2];
